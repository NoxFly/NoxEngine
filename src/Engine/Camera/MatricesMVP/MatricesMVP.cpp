...
MatricesMVP::MatricesMVP(double fov, double aspect, double near, double far, glm::vec3& verticalAxis):
    m_projection(glm::perspective(fov, aspect, near, far)),
    m_model(1.0f),
    m_view(glm::lookAt(glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), verticalAxis)),
    m_saves{},
    operationDone(true)
{
